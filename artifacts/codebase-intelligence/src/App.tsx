...
function RoutedApp() {
  ...
  useEffect(() => { if (location !== "/") sessionStorage.setItem("codebase-workspace-active", "true"); }, [location]);
  useEffect(() => { if (location === "/" && sessionStorage.getItem("codebase-workspace-active") === "true") navigate("/dashboard", { replace: true }); }, [location, navigate]);
  ...
  if (location === "/vulnerabilities") return <VulnerabilityScanner />;
